...
At My Kart, we believe that shopping should be simple, secure, and enjoyable. That’s why we bring together a wide range of categories – from fashion, electronics, and accessories to home essentials, beauty, and lifestyle products – all in one place
      ...
      <div className='w-[100%] flex items-center justify-center flex-col gap-[10px]'>
        ...
        <div className='about-features-container w-[80%] flex items-center justify-center lg:flex-row flex-col py-[40px]'>
          ...
          <div className='about-feature-quality lg:w-[33%] w-[90%] h-[250px] border-[1px] border-gray-100 flex items-center justify-center gap-[20px] flex-col  px-[40px] py-[10px] text-[white] backdrop-blur-[2px] bg-[#ffffff0b]'>
          ...
          {/* Convenience feature */}
           <div className='about-feature-convenience lg:w-[33%] w-[90%] h-[250px] border-[1px] border-gray-100 flex items-center justify-center gap-[20px] flex-col  px-[40px] py-[10px] text-[white] backdrop-blur-[2px] bg-[#ffffff0b]'>
          ...
          {/* Exceptional Customer Service feature */}
           <div className='about-feature-service lg:w-[33%] w-[90%] h-[250px] border-[1px] border-gray-100 flex items-center justify-center gap-[20px] flex-col  px-[40px] py-[10px] text-[white] backdrop-blur-[2px] bg-[#ffffff0b]'>
