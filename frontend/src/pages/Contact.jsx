...
function Contact() {
  return (
    <div className='w-[99vw] min-h-[100vh] flex items-center justify-center flex-col  bg-gradient-to-br from-[#7c3aed] via-[#a855f7] to-[#c084fc] gap-8 md:gap-12 lg:gap-[50px] pt-24 md:pt-20 lg:pt-24 px-4 md:px-6 lg:px-8'>
      ...
      <div className='w-[100%]  flex items-center justify-center flex-col lg:flex-row'>
        ...
        <p className='lg:w-[80%] w-[100%] text-[15px] text-[white] lg:text-[18px] mt-[10px] font-bold'>Careers at Mykart</p>
