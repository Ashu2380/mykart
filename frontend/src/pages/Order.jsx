...
useEffect(()=>{
 loadOrderData()
  ...
  return (
    <div className='w-[99vw] min-h-[100vh] p-4 md:p-5 lg:p-[20px] pb-32 md:pb-36 lg:pb-[150px] overflow-hidden bg-gradient-to-br from-[#7c3aed] via-[#a855f7] to-[#c084fc] pt-24 md:pt-20 lg:pt-24'>
