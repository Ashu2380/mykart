        ...
        <div className='w-[100%] md:h-[30vh] h-[15vh]  md:mb-[0px] bg-blue-50 flex items-center justify-center md:px-[50px] px-[5px]'>
            <div className='md:w-[30%] w-[35%] h-[100%] flex items-start justify-center flex-col gap-[5px]  '>
                <div className='flex items-start justify-start gap-[5px] mt-[10px] md:mt-[40px]'>
                    ...
                    <p className='text-[19px] md:text-[20px] text-[black] '>Mykart</p>
            
                </div>
                <p className='text-[15px] text-[#1e2223] hidden md:block'>Mykart is your all-in-one online shopping destination, offering top-quality products, unbeatable deals, and fast delivery—all backed by trusted service designed to make your life easier every day.</p>
                    <p className='text-[15px] text-[#1e2223] flex md:hidden'>Fast. Easy. Reliable. Mykart Shopping</p>
            ...
            <div className='md:w-[25%] w-[30%] h-[100%] flex items-center justify-center flex-col text-center'>
                ...
                <div className='md:w-[25%] w-[40%]  h-[100%] flex items-center justify-center flex-col text-center '>
                     ...
                     <ul>
                         <li className='text-[15px] text-[#1e2223] '>+91-6350395820</li>
                        <li className='text-[15px] text-[#1e2223] '>asharamsaini2380@gmail.com.com</li>
                        <li className='text-[15px] text-[#1e2223] hidden md:block'>+91 8058354712</li>
                        <li className='text-[15px] text-[#1e2223] hidden md:block'>asharam0088saini@gmail.com</li>
                    </ul>
                </div>
