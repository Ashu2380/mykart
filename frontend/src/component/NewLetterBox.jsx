...
function NewLetterBox() {
  ...
  return (
    <div className='w-[100%] h-[40vh]  bg-gradient-to-br from-[#7c3aed] via-[#a855f7] to-[#c084fc] flex items-center justify-start gap-[10px] flex-col'>
      <p className='md:text-[30px] text-[20px] text-[#a5faf7] font-semibold px-[20px]'>Subscribe now & get 15% off</p>
